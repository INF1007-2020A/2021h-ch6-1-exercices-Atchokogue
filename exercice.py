...
def anagrams(words: list = None) -> bool:
    if words is None:
        words = []
        while len(words) < 2:
            words.append(input("Entrez un mots: "))
...
def get_recipes():
    ...
    name = input("quel est le nom de cette recette?\n")
    ingredient = input("Entrer la liste d'ingédients, séparer les ingrédients par une ','\n")
...
def print_recipe(ingredients) -> None:
    ...
    else: print("Recette non-existante")
