...
class TestExercice(unittest.TestCase):
    def test_order(self):
        ...
        output = [exercicech6.order(v) for v in values]
    ...
    def test_anagram(self):
        ...
        answer = [True, False]
        output = [exercicech6.anagrams(v) for v in words]
    ...
    def test_doubles(self):
        ...
        output = [exercicech6.contains_doubles(v) for v in values]
        answer = [False, True]
    ...
    def test_grades(self):
        ...
        output = exercicech6.best_grades(value)
        answer = {"Sam": 85}
    ...
    def test_frequence(self):
        ...
        output = [exercicech6.frequence(s) for s in sentences]
